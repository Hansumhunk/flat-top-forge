...
- `index.html` — main site hub
- `recipes.html` — recipe library hub
  - category pages for breakfast, burgers, chicken, steak, hibachi, tacos, salads, seafood, vegetables, and desserts
  - `recipes/burgers/classic-smash-burgers.html`
  - `recipes/breakfast/loaded-breakfast-hash.html`
...
- `privacy.html` — current privacy practices
...
- Prefer primary manufacturer documentation for specifications and compatibility.
- Do not claim hands-on testing when a product has not been personally tested.
...
- First five standalone recipe URLs.
- First interactive utility: griddle size calculator.
- First evergreen gear buying guides.
